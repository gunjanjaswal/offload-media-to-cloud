...
class G33KI_Fix_Urls {

    public function __construct() {
        add_action('wp_ajax_g33ki_scan_urls', array($this, 'scan_urls_ajax'));
        add_action('wp_ajax_g33ki_fix_urls', array($this, 'fix_urls_ajax'));
    }
    ...
    public function fix_urls_ajax() {
        ...
        foreach ($ids as $attachment_id) {
            ...
            update_post_meta($attachment_id, 'g33ki_remote_url', $new_url);
            ...
            if (isset($metadata['sizes']) && is_array($metadata['sizes'])) {
                ...
                foreach ($metadata['sizes'] as $size => $size_data) {
                    $old_thumb_url = get_post_meta($attachment_id, 'g33ki_remote_url_' . $size, true);
                    ...
                    if (!empty($old_thumb_url)) {
                        ...
                        update_post_meta($attachment_id, 'g33ki_remote_url_' . $size, $new_thumb_url);
                    }
                }
            }
